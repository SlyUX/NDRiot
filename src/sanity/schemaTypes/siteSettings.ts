  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'orgAddLabel', title: 'Add-organisation legend', type: 'string' }),
        defineField({
          name: 'orgAddHint',
          title: 'Add-organisation hint',
          type: 'string',
          description: 'Under the name + URL rows for adding an org that isn’t listed.',
        }),
        defineField({ name: 'orgNamePlaceholder', title: 'Add-organisation — name placeholder', type: 'string' }),
