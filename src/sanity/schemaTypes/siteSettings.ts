...
export default defineType({
  ...
  groups: [
    ...
    { name: "noise", title: "ND Noise (newsletter)" },
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          type: "text",
          rows: 2,
          description: "Replaces the follow sections for a subscriber with no follows yet.",
        }),
        defineField({ name: "signoff", title: "Sign-off line", type: "string" }),
        defineField({ name: "footerLine", title: "Footer — why they got this", type: "text", rows: 2 }),
        defineField({ name: "unsubscribeLabel", title: "Unsubscribe link label", type: "string" }),
        defineField({ name: "unsubscribedHeading", title: "Unsubscribed page — heading", type: "string" }),
        defineField({ name: "unsubscribedBody", title: "Unsubscribed page — body", type: "text", rows: 3 }),
        defineField({
          name: "reviewReadySubject",
          title: "“Ready to review” email — subject",
          type: "string",
          description: "The email the monthly cron sends you when a draft issue is ready.",
        }),
        defineField({
          name: "reviewReadyBody",
          title: "“Ready to review” email — body",
          type: "text",
          rows: 8,
          description: "Token: {previewLink} — the admin preview URL.",
        }),
      ],
    }),
