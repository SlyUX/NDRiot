  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'ragPageTitle', title: 'Rag (magazine) — page title (H1)', type: 'string', description: 'The /magazine heading + meta title — e.g. "ND Riot Rag".' }),
        defineField({ name: 'ragPageDescription', title: 'Rag — meta description', type: 'text', rows: 2 }),
        ...
        defineField({ name: 'feedMineHeading', title: 'Hero rail — followed-updates heading', type: 'string', description: 'Heading over a signed-in reader’s followed-creator updates in the hero rail — e.g. "My Feed".' }),
        defineField({
        ...
        defineField({ name: 'accountTitle', title: 'Reader home — page title', type: 'string', description: 'Browser-tab title for /me — e.g. "Your ND Riot".' }),
        defineField({ name: 'accountUserHeading', title: 'Reader home — profile heading (reader)', type: 'string', description: 'When they own no creator — e.g. "User Profile".' }),
        defineField({ name: 'accountUserCreatorHeading', title: 'Reader home — profile heading (creator)', type: 'string', description: 'When they own a creator — e.g. "User + Creator Profile".' }),
        defineField({ name: 'accountComicsHeading', title: 'Reader home — your comics heading', type: 'string' }),
        ...
        defineField({ name: 'accountPostTargetPlaceholder', title: 'Reader home — update "About" placeholder', type: 'string', description: 'The unselected default option on the About picker — e.g. "Profile or Book update?".' }),
        defineField({ name: 'accountPostCreatorsGroup', title: 'Reader home — update picker: creators group', type: 'string', description: 'Heading for the creator options in the "About" picker — e.g. "Your Profiles".' }),
        defineField({ name: 'accountPostComicsGroup', title: 'Reader home — update picker: comics group', type: 'string', description: 'Heading for the comic options in the "About" picker — e.g. "Your Comics".' }),
        defineField({ name: 'accountPostKindLabel', title: 'Reader home — update "Kind" field label', type: 'string', description: 'Label on the update-kind picker — e.g. "Type of Update". The kinds themselves are a fixed list in code.' }),
        defineField({ name: 'accountPostKindPlaceholder', title: 'Reader home — update "Kind" placeholder', type: 'string', description: 'The unselected default option on the kind picker — e.g. "Select One".' }),
        defineField({ name: 'accountPostPlaceholder', title: 'Reader home — update text placeholder', type: 'string', description: 'Placeholder in the update box — e.g. "What’s new?".' }),
        defineField({ name: 'accountPostMentionsLabel', title: 'Reader home — update mentions label', type: 'string', description: 'Label over the optional creator/convention references — e.g. "Mention (optional)".' }),
        defineField({ name: 'accountPostMentionSearch', title: 'Reader home — mentions search placeholder', type: 'string', description: 'Placeholder in the mentions search box — e.g. "Search creators and conventions…".' }),
        defineField({ name: 'accountPostMentionNoMatch', title: 'Reader home — mentions no-match line', type: 'string', description: 'Shown when a mentions search finds nothing — e.g. "No matches.".' }),
        defineField({ name: 'accountPostMentionCreators', title: 'Reader home — mentions: creators group', type: 'string', description: 'Heading for the creator results — e.g. "Creators".' }),
        defineField({ name: 'accountPostMentionConventions', title: 'Reader home — mentions: conventions group', type: 'string', description: 'Heading for the convention results — e.g. "Conventions".' }),
        defineField({ name: 'accountPostSubmitLabel', title: 'Reader home — post-update button', type: 'string', description: 'e.g. "Post Update".' }),
        ...
        defineField({ name: 'accountNewsletterHeading', title: 'Reader home — newsletter opt-in heading', type: 'string', description: 'e.g. "Monthly Updates".' }),
        defineField({ name: 'accountNewsletterBody', title: 'Reader home — newsletter opt-in pitch', type: 'text', rows: 2, description: 'Shown to a signed-in reader who hasn’t opted in. Mention double opt-in + unsubscribe.' }),
        defineField({ name: 'accountNewsletterCta', title: 'Reader home — newsletter opt-in button', type: 'string', description: 'e.g. "Sign me up". After a click, the reader sees the newsletter’s confirm/​error message; no status is stored (MailerLite owns it).' }),
        defineField({ name: 'footerGetListedHeading', title: 'Footer — "Get Listed" heading', type: 'string' }),
        defineField({ name: 'footerRiotHeading', title: 'Footer — "The Riot" heading', type: 'string' }),
        defineField({ name: 'footerJoinCreatorsLabel', title: 'Footer — join as creator link', type: 'string', description: 'Links to /join/creators — e.g. "Comic Creators".' }),
        defineField({ name: 'footerJoinComicsLabel', title: 'Footer — list a comic link', type: 'string', description: 'Links to /join/books — e.g. "Comics".' }),
        defineField({ name: 'footerJoinMediaLabel', title: 'Footer — list media link', type: 'string', description: 'Links to /join/media — e.g. "Media".' }),
        defineField({ name: 'footerAboutLabel', title: 'Footer — About link', type: 'string' }),
        defineField({ name: 'navLoginLabel', title: 'Header — logged-out Login link', type: 'string', description: 'Starts Google sign-in — e.g. "Login".' }),
        defineField({ name: 'navJoinLabel', title: 'Header — logged-out Join link', type: 'string', description: 'Links to /join — e.g. "Join".' }),
        defineField({
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'conventions', title: 'No conventions', type: 'string' }),
        defineField({ name: 'ragIssues', title: 'No Rag issues', type: 'string' }),
