  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'accountPostKindLabel', title: 'Reader home — update "Kind" field label', type: 'string', description: 'Label on the update-kind picker — e.g. "Kind". The kinds themselves are a fixed list in code.' }),
        ...
        defineField({ name: 'accountPostMentionCreators', title: 'Reader home — mentions: creators group', type: 'string', description: 'Heading for the creator checkboxes — e.g. "Creators".' }),
        defineField({ name: 'accountPostMentionConventions', title: 'Reader home — mentions: conventions group', type: 'string', description: 'Heading for the convention checkboxes — e.g. "Conventions".' }),
