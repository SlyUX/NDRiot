  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'conventionsResourcesLinkLabel', title: 'Conventions — link label from Resources', type: 'string', description: 'The cross-link on /resources pointing to the conventions directory — e.g. "Browse conventions".' }),
